...
根据[commander文档](https://github.com/tj/commander.js/blob/master/Readme_zh-CN.md#%e5%b8%b8%e7%94%a8%e9%80%89%e9%a1%b9%e7%b1%bb%e5%9e%8bboolean-%e5%9e%8b%e9%80%89%e9%a1%b9%e5%92%8c%e5%b8%a6%e5%8f%82%e6%95%b0%e9%80%89%e9%a1%b9)的一些参数，我们来编写脚本 `yyt.js`
...
commander自带 `-V` 和 `-h` 两个命令，运行 `yyt -h`可看到：
		...
		inquirer.prompt(questions)
			.then(({projectName, frameWork}) => {
				switch (frameWork) {
					case 'React':
						download(
							'direct:git@github.com:ys558/yyt-template.git',
							projectName,
							{ clone: true },
							(err) => {
								// 错误回调：
...
## [完整代码仓库](https://github.com/ys558/my-node-cli-yyt)
