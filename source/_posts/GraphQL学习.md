...
tags:
    - GraphQL
cover: https://cdn.jsdelivr.net/gh/ys558/my-blog-imgs@0.17/articles/GraphQL学习/cover.png
---
...
![传统RestAPI效率低](GraphQL学习/0.0.png)

GraphQL则可以精确查找想要的字段，效率显著提高：
![GraphQL效率高](GraphQL学习/0.1.png)
...
1. 运行`yarn ds5`，浏览器输入：
    ...
    ```
    可以看到增加一个作者成功：
    ![单个查询](GraphQL学习/5.2.png)

    点击右上角的 < Docs，可以发现该文件的Mutation函数，其中`!`意为必要字段：
    ![单个查询](GraphQL学习/5.png)
